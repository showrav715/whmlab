                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="billing_cycle" class="form-control" required>
                                    ...
                                    <option value="monthly" {{ old('billing_cycle') === 'monthly' ? 'selected' : '' }}>@lang('Monthly')</option>
                                    <option value="yearly" {{ old('billing_cycle') === 'yearly' ? 'selected' : '' }}>@lang('Yearly')</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="4" placeholder="Plan description">{{ old('description') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
